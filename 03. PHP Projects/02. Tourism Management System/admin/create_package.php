                  ...
                  <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-6 pl-md-0">
                        ...
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="text" class="form-control" name="packagetype" id="packagetype" placeholder="enter package type" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="form-group col-md-6 pl-md-0">
                      ...
                      <div class="col-sm-12 pl-0 pr-0">
                        <input type="text" class="form-control" name="packageprice" id="packageprice" placeholder="enter Price for package" required>
                      </div>
                    </div>
                  </div>
